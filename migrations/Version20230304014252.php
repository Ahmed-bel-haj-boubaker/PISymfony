 ...
 */
final class Version20230304014252 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD token VARCHAR(255) DEFAULT NULL, CHANGE roles roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', CHANGE phone phone INT NOT NULL, CHANGE date_join date_join DATETIME NOT NULL, CHANGE banned banned TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP token, CHANGE roles roles LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', CHANGE phone phone INT DEFAULT NULL, CHANGE date_join date_join DATETIME DEFAULT NULL, CHANGE banned banned TINYINT(1) DEFAULT NULL');
    }
}

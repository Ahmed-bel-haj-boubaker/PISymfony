 ...
 */
final class Version20230216023417 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD is_verified TINYINT(1) NOT NULL, CHANGE image image VARCHAR(255) NOT NULL, CHANGE date_join date_join DATETIME NOT NULL, CHANGE banned banned TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP is_verified, CHANGE image image VARCHAR(255) DEFAULT NULL, CHANGE date_join date_join DATETIME DEFAULT NULL, CHANGE banned banned TINYINT(1) DEFAULT NULL');
    }
}

 ...
 */
final class Version20230224014418 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE date_join date_join DATETIME NOT NULL, CHANGE banned banned TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE date_join date_join DATETIME DEFAULT NULL, CHANGE banned banned TINYINT(1) DEFAULT NULL');
    }
}

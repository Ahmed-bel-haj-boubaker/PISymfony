 ...
 */
final class Version20230212213628 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE hebergement (id INT AUTO_INCREMENT NOT NULL, image VARCHAR(255) NOT NULL, nom_heberg VARCHAR(255) NOT NULL, descreptionheber VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE transport (id INT AUTO_INCREMENT NOT NULL, image_transport VARCHAR(255) NOT NULL, nom_transport VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }

 ...
 */
final class Version20230215124928 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE hebergement DROP FOREIGN KEY FK_4852DD9CC68BE09C');
        $this->addSql('ALTER TABLE hebergement ADD CONSTRAINT FK_4852DD9CC68BE09C FOREIGN KEY (localisation_id) REFERENCES hebergement (id)');
    }
}
